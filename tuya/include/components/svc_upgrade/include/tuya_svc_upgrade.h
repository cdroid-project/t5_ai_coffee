...
#define BIN_TYPE_SING  0x53494E47 // 单区差分SING
#define BIN_TYPE_ABSI 0x41425349 //单区差分+AB分段差分
#define BIN_TYPE_OABSI 0x41425238 //单区差分+可覆盖AB分段差分
#define BIN_TYPE_COMPRESSION_SING 0x4C5A4350 //压缩
#define BIN_TYPE_COMPRESSION_OABSI 0x4C5A4351 //压缩+可覆盖AB分段
#define BIN_TYPE_COMPRESSION_ABSI 0x4C5A4352 //压缩+AB分段

#define BIN_STEP_A 0x12346789
#define BIN_STEP_B 0x67891234
...
typedef struct {
    UINT_T bin_type;
    UINT_T bin_step; // A or B
    UINT_T bin_offset;
    UINT_T bin_offset_backup;
    CHAR_T hmac[FW_HMAC_LEN + 1];
} multi_setion_t;
