...
/**
 * @brief get def attr flag
 *
 * @return attr flag
 *
 */
UINT_T gw_get_def_attribute(VOID);
...
VOID gw_dev_evt_set_cb(DEV_EVT_CB cb);
VOID gw_dev_evt_notify(DEV_EVT_E evt, DEV_ACTION_E action, VOID *ctx);
VOID gw_set_security_version(CHAR_T *ver);
#ifdef __cplusplus
}
#endif
