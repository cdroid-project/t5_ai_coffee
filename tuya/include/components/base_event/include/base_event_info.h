...
#define EVENT_LOCAL_KEY_UPDATE_REQ "localkey.upd.req" // local key update request
#define EVENT_LOCAL_KEY_UPDATE_ACK "localkey.upd.ack" // local key update ack
#define EVENT_LOCAL_KEY_UPDATE     "localkey.upd"    // local key update
...
#define EVENT_NETCFG_BEGIN       "netcfg_begin"    // netcfg begin event

#define EVENT_BLE_INIT    "ble.init"     // ble init event
#define EVENT_BLE_DEINIT  "ble.deinit"   // ble deinit event
#define EVENT_BLE_STACK_NOTIFY  "ble.stack.notify"  // ble stack notify
