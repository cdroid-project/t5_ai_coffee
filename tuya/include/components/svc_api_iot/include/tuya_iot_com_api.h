...
/**
 * @brief tuya_iot_dev_upgd_progress_with_remain_time
 *
 * @param[in] percent
 * @param[in] devid
 * @param[in] tp
...
OPERATE_RET tuya_iot_dev_upgd_progress_with_remain_time(IN CONST UINT_T percent,
                                                        IN CONST CHAR_T *devid, IN CONST DEV_TYPE_T tp, IN CONST UINT_T remain_time);
...
/**
 * @brief tuya_regist_dp_async_report_cb
 * @desc regist callback fucntion for dp async report.
 *
...
/**
 * @brief dev_sync_dp_json_async_force
 * @desc report dp info a-synced.
 *
 * @param[in] dev_id: if sub-device, then devid = sub-device_id
 *                if gateway/soc/mcu, then devid = NULL
 ...
 * @param[in] param: report params
 * @param[in] is_async: is async report
 *
 * @return OPRT_OK: success  Other: fail
 */
OPERATE_RET tuya_report_dp_raw(IN CONST CHAR_T *dev_id, IN CONST BYTE_T dpid, \
                              IN CONST BYTE_T *data, IN CONST UINT_T len, \
                              IN TY_DP_REPT_PARAM_SYNC* param, IN CONST BOOL_T is_async);
...
/**
 * @brief tuya_report_dp_sync
 * @desc report dp info status info synced.
 *
 * @param[in] dev_id: if sub-device, then devid = sub-device_id
 *                if gateway/soc/mcu, then devid = NULL
 * @param[in] dp_data: dp array header
...
/**
 * @brief tuya_iot_book_additional_topic
 * @desc subscribe additional topic
 *
 * @return OPRT_OK: success  Other: fail
 */
...
/**
 * @brief tuya_iot_send_mqtt_msg_with_topic
 * @desc send a custom protocol mqtt msg to topic
 *
 ...
 *
 * @param[in] p_msg: media data
 * @param[in] msg_len: media data len
 ...
 */
OPERATE_RET tuya_iot_media_data_report(BYTE_T *p_msg, UINT_T msg_len, UINT_T timeout);
...
#if 1//ext module
/***********************************************************
*  Function: tuya_iot_set_ext_auth_info
*  Input: emt: auth_info: include auth_key,uuid,psk_key in json code
*  Output: none
*  Return: OPERATE_RET
***********************************************************/
...
/***********************************************************
*  Function: tuya_iot_set_ext_module_type
*  Input: emt: ext module type
*  Output: none
*  Return: VOID_T
***********************************************************/
...
/***********************************************************
*  Function: tuya_iot_get_ext_module_type
*  Input: noe
*  Output: none
*  Return: ext module type
***********************************************************/
DEV_EXT_MODE_TYPE tuya_iot_get_ext_module_type(VOID);

/***********************************************************
*  Function: tuya_iot_get_ext_module_info
*  Input: none
*  Output: ext_module_info: ext module information
*  Return: OPERATE_RET
***********************************************************/
OPERATE_RET tuya_iot_get_ext_module_info(DEV_EXT_MODULE_INFO* ext_module_info);

/***********************************************************
*  Function: tuya_iot_set_ext_active_info
*  Input: active_info: active info in json code from ble
*  Output: none
*  Return: OPERATE_RET
***********************************************************/
