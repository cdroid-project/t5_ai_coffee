...
/**
 * @brief enable or disable force report repeat
 *
 * @param[in] enable if value is true, report repeat logseq, otherwise not report
 *
 * @note This API is used for enalbe or disable report repeat logseq, default is TRUE
 *
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
 */
...
/**
 * @brief delete network configure log sequence.
 *
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
 */
int log_seq_delete_netcfg_log(VOID);
