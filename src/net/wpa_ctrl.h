 ...
 * @LastEditTime: 2025-10-23 14:47:45
 * @FilePath: /t5_ai_coffee/src/net/wpa_ctrl.h
 * @Description: 
 * @BugList: 
 * 
...
/** WPA配置文件路径 */
#define WPA_SUPPLICANT_CFG "/param/wpa_supplicant.conf"
 ...
 * 写wpa配置文件
 */
void wpa_ctrl_write_conf(const char *ssid, const char *password, const char *encryptType);
