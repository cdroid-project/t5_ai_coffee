 ...
 * @LastEditTime: 2025-10-23 14:05:17
 * @FilePath: /t5_ai_coffee/src/windows/home_tab_mode_americano.h
 * @Description: 
 * @BugList: 
 * 
...
#ifndef _HOME_TAB_MODE_AMERICANO_H_
#define _HOME_TAB_MODE_AMERICANO_H_
...
class HomeTabModeAmericano {
public:
    HomeTabModeAmericano(ViewGroup *wind_page_box);
    ~HomeTabModeAmericano();
...
private:
    ...
    std::vector<RightInfoStr> ameRightInfoList;
    int mBeanItemState;
    int mCupItemState;
    int  mPageEditType;
    int  mFavEditPos;
